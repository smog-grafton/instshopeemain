function AddressIcon() {
  return (
    <svg
      fill="none"
      viewBox="0 0 121 120"
      className="h-[120px] w-[120px] overflow-hidden"
    >
      <path
...
export function AddressEmptyState() {
  return (
    <div className="box-border h-[500px] p-8 items-center flex flex-col justify-center">
      <AddressIcon />
      <div className="text-black/65 text-base font-medium leading-6 mt-4 text-center">
