...
export function ShopMainHeader({ shopSlug }: ShopMainHeaderProps) {
  return (
    <div
      className="flex items-center py-3.5 pb-5 border-b border-black/10 z-[300] min-w-[1200px]"
      style={{ backgroundColor: SHOP_HEADER_BG }}
    >
      <div className="mx-auto flex items-center w-[1200px]">
        {/* Logo area per reference: bag SVG link + separator (border-right) + Shopee Mall SVG link */}
        <div className="flex items-center shrink-0 mr-[15px]">
          <Link
            href="/"
          ...
          >
            <svg
              ...
              viewBox="0 0 48 48"
              className="h-[45px] w-[2.5rem] fill-white block relative overflow-hidden cursor-pointer"
              aria-hidden
            >
          ...
          <div
            className="h-[45px] w-px shrink-0 mx-4 bg-white/40 self-center"
            aria-hidden
            role="presentation"
          />
          <Link
          ...
          >
            <svg
              viewBox="0 0 220 44"
              className="max-w-[165px] h-[33px] w-auto top-[5px] fill-white block relative overflow-hidden"
              aria-hidden
            >
        ...
        {/* Search: fixed width per reference (style-10 + style-11) */}
        <div className="flex items-center w-[36.875rem] shrink-0">
