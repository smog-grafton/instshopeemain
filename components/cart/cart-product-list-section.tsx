      ...
      <div className="mb-3 flex h-[55px] items-center overflow-hidden rounded-[3px] bg-white px-5 text-[14px] leading-4 text-black/60 shadow-[rgba(0,0,0,0.05)_0px_1px_1px_0px]">
        <div className="flex min-w-[58px] flex-row-reverse px-3 pl-5">
          <label className="flex max-w-[400px] cursor-default items-center text-xs font-light text-black/60">
            ...
            />
            <span className="h-4 w-4 rounded-[2px] border border-black/20 shadow-[rgba(0,0,0,0.02)_0px_2px_0px_0px_inset]" />
          </label>
        </div>
          ...
          >
            ...
            >
              {group.items.map((item) => {
                ...
                return (
                  <div
                    key={`${item.slug}-${item.colorLabel ?? ""}-${item.size ?? ""}-${item.shopSlug ?? ""}`}
                    role="listitem"
                  ...
                  <div className="flex w-[14.5548%] items-center justify-center">
                    <div className="flex items-center">
                      <button
                        ...
                        // quantity updates: will come later when we wire updateQuantity
                      >
                        <svg
                          viewBox="0 0 10 10"
                  ...
                  <div className="flex w-[11.9863%] flex-col items-center justify-center text-[14px] capitalize">
                    <button
                      type="button"
                      className="border-0 bg-transparent text-black/87"
                      onClick={() =>
            ...
            <div className="flex items-center border-t border-black/10 px-10 py-5">
              ...
              <div className="text-black/87">
                Up to RM5.00 off shipping for orders over RM30.00
              </div>
              <button
                type="button"
