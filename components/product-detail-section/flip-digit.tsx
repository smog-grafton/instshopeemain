...
/** Vertical sliding / slot-machine style digit: strip of 0–9, translateY to show value. */

const DIGIT_HEIGHT_PX = 16;

// SVG paths for digits 0-9
const DIGIT_PATHS: Record<number, { path: string; viewBox: string }> = {
  0: {
    ...
    >
      ...
      >
        {Array.from({ length: 10 }, (_, i) => (
          <div
            key={i}
            className="w-2.5 flex items-center justify-center flex-shrink-0 relative"
            style={{ height: DIGIT_HEIGHT_PX }}
          >
            <svg
