export interface DailyDiscoverProduct {
  ...
  promotionLabel?: string; // e.g. "15% off", "$9 off", "$0.3 off"
...
export const dailyDiscoverProducts: DailyDiscoverProduct[] = [
  ...
  { id: "5", title: "ELGINI E16028 Seluar Track Slim-Fit S-XXL | Slim-Fit Track Pants", discountPercent: 86, price: "29.90", sold: "1000k+", href: "#", findSimilarHref: "#", imageIndex: 5, hasVideo: true, badges: ["shopee-lagi-murah"], promotionLabel: "$9 off", hasFlagLabel: true },
  ...
  { id: "9", title: "【READY STOCK】Men's Automatic Quartz Watch Hollow Waterproof Luminous Watch High-End Business Watches Jam Tangan", discountPercent: 84, price: "4.07", sold: "3k+", href: "#", findSimilarHref: "#", imageIndex: 2, hasVideo: true, badges: ["shopee-lagi-murah"], promotionLabel: "$0.59 off" },
  ...
  { id: "12", title: "Iron Ceramic Hair Straightener Styling Tools Machine 2 in 1 Hair Straightener Hair Curler Wet Dry Pelurus Rambut 直发棒", discountPercent: 86, price: "13.90", sold: "10k+", href: "#", findSimilarHref: "#", imageIndex: 5, hasVideo: false, badges: ["shopee-lagi-murah"], promotionLabel: "$2 off" },
  ...
  { id: "21", title: "Beg bagasi 14/16/20/24 Inch Abs Hardshell Lightweight Carry On Suitcase Travel Luggage G Hook", discountPercent: 17, price: "24.90", sold: "3k+", href: "#", findSimilarHref: "#", imageIndex: 7, hasVideo: false, badges: ["shopee-lagi-murah"], promotionLabel: "$6 off" },
